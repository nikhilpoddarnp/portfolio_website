   ...
   <section id='contact'>
    <div id='social'>
        ...
        <div className='socialImgs'>
           ...
           <a href='https://instagram.com/nikhilpoddarnp' >  <img src= {Instagram} alt='Instagram' className='socialImg' /> </a>
           <a href='https://facebook.com/nikhilpoddarnp'>  <img src= {Facebook} alt='Facebook' className='socialImg' /> </a>
