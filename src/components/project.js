  ...
  return (
   <section id='project'>
    ...
    <div className='project-item'>
        ...
        <a href='#' onClick={(e) => e.preventDefault()}><img src={Task} alt='Project-1' className='projectImg'/></a>
    ...
    <div className='project-item'>
        ...
        <a href='#' onClick={(e) => e.preventDefault()}><img src={Recipe} alt='Project-1' className='projectImg'/></a>
